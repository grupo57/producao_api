...
public class Atendimento {
	...
	public Atendimento(Long id, Long idPedido, String codigo, SituacaoDoAtendimento situacao, LocalDateTime recebido,
			LocalDateTime iniciado, LocalDateTime preparado, LocalDateTime concluido, Collection<ProdutoDTO> produtos) {
		this();
		this.id = id;
	...
	public Atendimento(Long id, Long idPedido, String codigo, LocalDateTime iniciado, LocalDateTime preparado,
			LocalDateTime concluido, Collection<ProdutoDTO> produtos) {
		this();
		this.id = id;
		this.idPedido = idPedido;
		this.codigo = codigo;
	...
	public static Atendimento recebido(Long id, Long idPedido, String codigo, Collection<ProdutoDTO> produtos) {
		return new Atendimento(id, idPedido, codigo, SituacaoDoAtendimento.RECEBIDO, LocalDateTime.now(), null, null,
				null, produtos);
	}
